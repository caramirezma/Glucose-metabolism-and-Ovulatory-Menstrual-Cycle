...
function [dx]=coupling_Glucose_E2P4_GynCycleinput(t,x,input)
...
par.R_0= 890; %FAST-864 NonFast-890 %[mg/dL.d] %Net rate of production at zero glucose, based on Topp et al.
par.E_G0=8; %FAST-10 NONFAST-8      %[1.d]     %Insulin independent glucose disposal rate-Total glucose effectiveness at "zero insulin" based on Topp et al.
